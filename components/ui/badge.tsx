...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
          'border-transparent bg-blue-600/30 text-blue-300 border-blue-500/30',
        secondary:
          'border-transparent bg-blue-900/40 text-blue-200 border-blue-800/30',
        destructive:
          'border-transparent bg-red-500/20 text-red-400 border-red-500/30',
        outline: 'text-blue-200/80 border-blue-700/40',
