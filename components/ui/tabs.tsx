...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-xl bg-blue-900/30 border border-blue-800/30 p-1 text-blue-200/60',
      className
    )}
    {...props}
  />
