      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href={`/${locale}`} className="inline-flex items-center gap-2.5 group">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-500/30 mx-auto mb-4">
              <Globe className="w-7 h-7 text-white" />
            </div>
          </Link>
          <h1 className="text-2xl font-bold text-white">{t('signInTitle')}</h1>
          <p className="text-blue-200/60 mt-2">{t('signInSubtitle')}</p>
        </div>
